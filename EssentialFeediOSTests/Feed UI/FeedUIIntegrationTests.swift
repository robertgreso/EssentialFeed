...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_cancelImageURLPreloadingWhenNotNearVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected second cancelled image URL request once seconde image is not near visible anymore")
    }
