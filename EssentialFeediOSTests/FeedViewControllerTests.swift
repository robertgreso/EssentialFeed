...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once loding is completed")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once user initiates a reload")

        loader.completeFeedLoading(at: 1)
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Explected no loading indicator once user initiated loading is completed")
    }
